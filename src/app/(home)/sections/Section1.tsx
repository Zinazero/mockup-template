...
export const Section1 = () => {
  const locations: Location[] = [
    { location: 'GALT', subLocation: 'CAMBRIDGE', imgSrc: '/locations/galt.png', href: '/galt' },
    { location: 'NIAGARA FALLS', imgSrc: '/locations/niagara.png', href: '/niagara' },
    { location: 'PRESTON', subLocation: 'CAMBRIDGE', imgSrc: '/locations/preston.png', href: '/preston' },
  ];
